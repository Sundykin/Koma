...
- [x] 3.4 StepNavigator 显示当前正在编辑的分集信息
...
- [x] 5.1 修改 projectStore 支持按分集加载/保存创作数据
- [x] 5.2 实现 episodes/{id}/script.md 分集剧本存储
- [x] 5.3 实现 episodes/{id}/analysis.json 分集解析结果存储
- [x] 5.4 实现 episodes/{id}/shots/ 分集分镜存储
...
- [x] 6.3 分集解析时使用 AssetReference 引用而非复制
...
- [x] 9.1 创建 EpisodeSplitWizard 分集向导组件
