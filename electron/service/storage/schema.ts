...
CREATE TABLE IF NOT EXISTS linghui_workspaces (
  id TEXT PRIMARY KEY,
  name TEXT NOT NULL,
  description TEXT,
  created_at INTEGER NOT NULL,
  ...
  graph_version INTEGER NOT NULL DEFAULT 2
);

CREATE TABLE IF NOT EXISTS linghui_workspace_groups (
  id TEXT PRIMARY KEY,
  workspace_id TEXT NOT NULL REFERENCES linghui_workspaces(id) ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS linghui_workspace_nodes (
  id TEXT PRIMARY KEY,
  workspace_id TEXT NOT NULL REFERENCES linghui_workspaces(id) ON DELETE CASCADE,
  type TEXT NOT NULL,
  position_x REAL NOT NULL,
...
CREATE TABLE IF NOT EXISTS linghui_workspace_edges (
  id TEXT PRIMARY KEY,
  workspace_id TEXT NOT NULL REFERENCES linghui_workspaces(id) ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS linghui_workspace_node_runs (
  workspace_id TEXT NOT NULL REFERENCES linghui_workspaces(id) ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS linghui_workspace_execution_logs (
  id TEXT PRIMARY KEY,
  workspace_id TEXT NOT NULL REFERENCES linghui_workspaces(id) ON DELETE CASCADE,
  level TEXT NOT NULL,
...
CREATE TABLE IF NOT EXISTS linghui_workflow_templates (
  id TEXT PRIMARY KEY,
  workspace_id TEXT NOT NULL REFERENCES linghui_workspaces(id) ON DELETE CASCADE,
  name TEXT NOT NULL,
  description TEXT,
  source TEXT NOT NULL CHECK(source IN ('workspace')),
  kind TEXT NOT NULL CHECK(kind IN ('saved-workflow')),
  recipe_key TEXT,
  created_at INTEGER NOT NULL,
  updated_at INTEGER NOT NULL,
  ...
  link_count INTEGER NOT NULL DEFAULT 0,
  group_count INTEGER NOT NULL DEFAULT 0,
  sample_node_labels_json TEXT NOT NULL DEFAULT '[]'
);

CREATE TABLE IF NOT EXISTS linghui_workflow_template_groups (
  id TEXT PRIMARY KEY,
  template_id TEXT NOT NULL REFERENCES linghui_workflow_templates(id) ON DELETE CASCADE,
  position_x REAL NOT NULL,
  position_y REAL NOT NULL,
  label TEXT NOT NULL,
  color TEXT NOT NULL,
...
CREATE TABLE IF NOT EXISTS linghui_workflow_template_nodes (
  id TEXT PRIMARY KEY,
  template_id TEXT NOT NULL REFERENCES linghui_workflow_templates(id) ON DELETE CASCADE,
  type TEXT NOT NULL,
  position_x REAL NOT NULL,
...
CREATE TABLE IF NOT EXISTS linghui_workflow_template_edges (
  id TEXT PRIMARY KEY,
  template_id TEXT NOT NULL REFERENCES linghui_workflow_templates(id) ON DELETE CASCADE,
  source_node_id TEXT NOT NULL,
  target_node_id TEXT NOT NULL,
...
CREATE TABLE IF NOT EXISTS linghui_workspace_assets (
  id TEXT PRIMARY KEY,
  workspace_id TEXT NOT NULL REFERENCES linghui_workspaces(id) ON DELETE CASCADE,
  node_id TEXT NOT NULL,
...
CREATE TABLE IF NOT EXISTS linghui_workspace_history_records (
  id TEXT PRIMARY KEY,
  workspace_id TEXT NOT NULL REFERENCES linghui_workspaces(id) ON DELETE CASCADE,
  node_id TEXT NOT NULL,
  node_type TEXT NOT NULL,
...
CREATE INDEX IF NOT EXISTS idx_linghui_workspaces_updated ON linghui_workspaces(updated_at DESC);
CREATE INDEX IF NOT EXISTS idx_linghui_workspace_groups_workspace ON linghui_workspace_groups(workspace_id, sort_order);
CREATE INDEX IF NOT EXISTS idx_linghui_workspace_nodes_workspace ON linghui_workspace_nodes(workspace_id, sort_order);
CREATE INDEX IF NOT EXISTS idx_linghui_workspace_edges_workspace ON linghui_workspace_edges(workspace_id, sort_order);
CREATE INDEX IF NOT EXISTS idx_linghui_workspace_runs_workspace ON linghui_workspace_node_runs(workspace_id, node_id);
CREATE INDEX IF NOT EXISTS idx_linghui_workspace_logs_workspace ON linghui_workspace_execution_logs(workspace_id, sort_order);
CREATE INDEX IF NOT EXISTS idx_linghui_templates_workspace ON linghui_workflow_templates(workspace_id, updated_at DESC);
CREATE INDEX IF NOT EXISTS idx_linghui_template_groups_template ON linghui_workflow_template_groups(template_id, sort_order);
CREATE INDEX IF NOT EXISTS idx_linghui_template_nodes_template ON linghui_workflow_template_nodes(template_id, sort_order);
...
`,
  ...
  4: {
    description: 'Persist Linghui workspaces and libraries in SQLite',
    sql: `
CREATE TABLE IF NOT EXISTS linghui_workspaces (
  id TEXT PRIMARY KEY,
  name TEXT NOT NULL,
