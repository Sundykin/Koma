...
const ALLOWED_INVOKE_CHANNELS = new Set([
  ...
  'controller/linghui/listWorkspaces', 'controller/linghui/loadWorkspace',
  'controller/linghui/saveWorkspace', 'controller/linghui/createWorkspace',
  'controller/linghui/saveWorkspaceAs', 'controller/linghui/deleteWorkspace',
  'controller/linghui/importWorkspace', 'controller/linghui/exportWorkspace',
...
contextBridge.exposeInMainWorld('electronAPI', {
  ...
  linghui: {
    listWorkspaces: () => invokeMain('controller/linghui/listWorkspaces', {}),
    loadWorkspace: (workspaceId: string) => invokeMain('controller/linghui/loadWorkspace', { workspaceId }),
    saveWorkspace: (doc: any) => invokeMain('controller/linghui/saveWorkspace', { doc }),
    createWorkspace: (name?: string) => invokeMain('controller/linghui/createWorkspace', { name }),
    saveWorkspaceAs: (doc: any, name?: string) => invokeMain('controller/linghui/saveWorkspaceAs', { doc, name }),
    deleteWorkspace: (workspaceId: string) => invokeMain('controller/linghui/deleteWorkspace', { workspaceId }),
    importWorkspace: (filePath: string) => invokeMain('controller/linghui/importWorkspace', { filePath }),
    exportWorkspace: (doc: any, destPath: string) => invokeMain('controller/linghui/exportWorkspace', { doc, destPath }),
    getWorkspaceDir: (workspaceId: string) => invokeMain('controller/linghui/getWorkspaceDir', { workspaceId }),
    listWorkflowTemplates: (workspaceId: string) => invokeMain('controller/linghui/listWorkflowTemplates', { workspaceId }),
  ...
  ffmpeg: {
    ...
    concatMediaClips: (options: any) => invokeMain('controller/ffmpeg/concatMediaClips', options),
    concatAudioClips: (options: any) => invokeMain('controller/ffmpeg/concatAudioClips', options),
    trimVideo: (options: any) => invokeMain('controller/ffmpeg/trimVideo', options),
    upscaleVideo: (options: any) => invokeMain('controller/ffmpeg/upscaleVideo', options),
