...
const INLINE_STYLE_EXPRESSION_EXCEPTIONS = new Set([
  // React Flow BaseEdge requires the upstream edge style object to be forwarded.
  'src/components/linghui/canvas/components/LinghuiEdge.tsx:73',
]);
