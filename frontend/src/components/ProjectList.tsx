...
import { Plus, Clock, Search, Filter, MoreHorizontal, FileText, Film, PlayCircle, CheckCircle2 } from 'lucide-react';
                ...
                return (
                    ...
                    >
                        ...
                        <div className="aspect-[16/10] bg-gray-900 relative overflow-hidden">
                            ...
                            {/* 更多操作 (Hover 显示) */}
                            <button className="absolute top-3 right-3 p-1.5 bg-black/50 hover:bg-black/80 text-white rounded opacity-0 group-hover:opacity-100 transition-opacity backdrop-blur">
