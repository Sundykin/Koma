...
export const LinghuiCanvasContextMenu: React.FC<LinghuiCanvasContextMenuProps> = ({
  ...
  contextMenuMediaActionState,
  contextMenuSelectionIds: _contextMenuSelectionIds,
  ...
  onOpenDownstreamQuickCreate: _onOpenDownstreamQuickCreate,
  onCreateAssetFromNode,
  onOpenPanoramaPreviewFromNode,
  onCreateSubjectFromNode,
  onCopyPrimaryImageFromNode,
  onSeparateVideoAudioFromNode: _onSeparateVideoAudioFromNode,
  onReturnToGenerator: _onReturnToGenerator,
  ...
  onRunCurrentNode: _onRunCurrentNode,
  onRunCurrentGroup,
  ...
  onUploadAudios,
  onFormatLayout,
  onOpenShortcutPanel: _onOpenShortcutPanel,
  onPaste,
  onUndo,
  onRedo,
  onRunAll: _onRunAll,
  onRunSelection: _onRunSelection,
  onExportSelection: _onExportSelection,
  onSaveSelectionAsWorkflow: _onSaveSelectionAsWorkflow,
  onCopySelection: _onCopySelection,
  onDuplicateSelection: _onDuplicateSelection,
