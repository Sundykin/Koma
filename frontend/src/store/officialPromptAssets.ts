...
export const OFFICIAL_PROMPT_ASSETS: OfficialPromptAsset[] = [
  ...
  {
    id: 'official-chapter-division-10000',
    sourceFile: 'preset_chapter_division.json',
    sourceTemplateId: '10000',
    name: '智能章节划分',
    order: 1,
    category: 'chapter-division',
    platform: '默认',
    model: '默认',
    mappedOperatorId: 'chapter-division-smart',
    contentPreview: '根据总分镜数与文案结构生成章节标题、起止范围和 plot。',
  },
  {
    id: 'official-chapter-division-10001',
    sourceFile: 'preset_chapter_division.json',
    ...
    platform: '默认',
    model: '默认',
    mappedOperatorId: 'chapter-division-even',
    contentPreview: '以 4-6 个章节均匀切分镜头，适合先建立稳定节奏。',
  },
  {
